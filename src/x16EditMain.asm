...
L01F3:	lda     (sp)
	cmp     #$01
	jne     incsp1
L01F5:	lda     __editorLinesCapacity
	clc
...
L01BE:	jsr     _Invalidate
	jmp     _PrintLineNumber
L01B1:	stz     __textPos+4
	stz     __textPos+2
	jmp     _CursorDown
