...
L023F:	lda     (sp)
	cmp     #$01
	jne     incsp1
L0241:	lda     __editorLinesCapacity
	clc
...
.segment	"CODE"
	...
	cmp     __textPos
	beq     L01EA
L0267:	jsr     _SaveBufferToEditorMemory
	lda     __textPos
	ldx     __textPos+1
	ina
	bne     L01EF
...
L0206:	jsr     _Invalidate
	jmp     _PrintLineNumber
L01F9:	stz     __textPos+4
	stz     __textPos+2
	jmp     _CursorDown
